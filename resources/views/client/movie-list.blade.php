                                ...
                                <div class="row mb-10 justify-content-center">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">on watch</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">horror night</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">the lost name</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">calm stedfast</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">criminal on party</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">halloween party</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('detail') }}">the most wanted</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie02.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie03.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie04.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie05.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie06.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie07.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie08.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie09.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie10.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie11.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('detail') }}" class="w-100 bg_img h-100"
                                                ...
                                                <img class="d-sm-none" src="assets/images/movie/movie12.jpg"
                                                    alt="movie">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
